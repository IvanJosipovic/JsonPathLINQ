...
internal sealed class LegacyJsonPathAdapter
{
    ...
    private LegacyJsonPathAdapter(string name)
    {
        Root = new ListNode();
    }
    ...
    public static LegacyJsonPathAdapter Parse(string name, string text)
    {
        var parser = new LegacyJsonPathAdapter(name);
        parser.ParseInternal(text);
        return parser;
    }

    internal static LegacyJsonPathAdapter ParseAction(string name, string text)
    {
